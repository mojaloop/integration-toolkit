...
vault_api POST /v1/sys/mounts/secret '{"type": "kv-v2"}' > /dev/null
...
vault_api POST /v1/sys/mounts/pki_int/tune '{"default_lease_ttl": "8760h", "max_lease_ttl": "87600h"}' > /dev/null
vault_api POST /v1/pki_int/roles/example.com '{"allowed_domains": "example.com", "allow_subdomains": true, "allow_any_name": true, "allow_localhost": true, "enforce_hostnames": false, "max_ttl": "4000h", "ttl": "4000h"}' > /dev/null
